...
class Bdb:
    ...
    The standard debugger class (xpdb.Pdb) is an example.
    """
    ...
    def do_clear(self, arg):
        raise NotImplementedError, "subclass of xbdb must implement do_clear()"
    ...
    def user_flagReset(self):
        self.clear_stepNextTimes()
        self.user_stopHereFlag = False
        self.info_for_finish = None
        
    def clear_stepNextTimes(self):
        self.remainStepTimes = 0
        self.remainNextTimes = 0        
    ...
    def update_remainStepNext(self, frame):
            if self.remainStepTimes > 0 :
                ...
                self.remainNextTimes -= 1
                sstack, curindex = self.get_stack(frame, None)
                curframe = sstack[curindex][0]
                self.set_next(curframe)
        
    def set_finish(self, frame):
        finishP = getFinishLine(frame)
        self.info_for_finish = finishP.getStart_EndLine()
        self._set_stopinfo(self.botframe, None, -1)        
        
    def set_watchPoint(self,  frame, arg):
        self.traceEveryLine = True
        watchPointerList.addWatchPoint(frame, arg)

    def unset_watchPoint(self, arg):
        watchPointerList.removeWatchPoint(arg)

    def infoWatchPoint(self):
        watchPointerList.showWatchPoint()
        
    def set_traceEveryLine(self):
        self.traceEveryLine = True
    ...
    def set_step(self):
        ...
        # Issue #13183: xpdb skips frames after hitting a breakpoint and running
        # step commands.
    ...
    def set_continue(self):
        ...
        self._set_stopinfo(self.botframe, None, -1)
        if not (self.breaks or self.traceEveryLine):
